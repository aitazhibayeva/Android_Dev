...
import com.example.dodopizza.models.PizzaItem
...
class PizzaAdapter(
    ...
    private val pizzaList: ArrayList<PizzaItem> = ArrayList()

    fun setData(pizzas: ArrayList<PizzaItem>) {
        pizzaList.clear()
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        if (pizzaList[position] is Pizza) {
            holder.bind(pizzaList[position] as Pizza)
        }
    }
}
